...
//sticky header
  ...
  if(!empty($button_Color_hover2)) $button_Color_hover2 = $button_Color_hover2;
	...
	//if($lazy_loader_size=='medium')
	//$size_loader = 'width:50px; height:50px;';
	//elseif($lazy_loader_size=='small')
	//$size_loader = 'width:35px; height:35px;';
	//elseif($lazy_loader_size=='large')
	//$size_loader = 'width:70px; height:70px;';
	...
	$output .= '.loader div, .cssload-inner{ border-color:'.$l_icon_color.' !important }';
	}
