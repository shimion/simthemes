    ...
    $.fn.carousel = function (param) {
        ...
        $(this).each(function(index, target) {
            ...
            if (typeof param === 'object' && param !== null) {
                ...
                $target.find('.3d-left').off('click').on('click', (function($target) {
                    return function() {
                        scroll($target, 'left');
                    }
                })($target));
                $target.find('.3d-right').off('click').on('click',(function($target) {
                    return function() {
                        scroll($target, 'right');
                    }
                })($target));
